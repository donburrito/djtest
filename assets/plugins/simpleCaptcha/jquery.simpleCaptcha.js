...
(function($) {
    ...
    $.fn.simpleCaptcha = function(o) {
        ...
        if (!c) {
            n.trigger('error.' + ns, ['No node provided for the simpleCaptcha UI']);
        }
    ...
    $.jk.SimpleCaptcha = function(o) {
        ...
        if (o.numImages && (!Number(o.numImages) || o.numImages < 1)) {
            o.numImages = t.numImages;
        }
        $.extend(t, ((o) ? o : {}));
